...
bool HRedisBase::GetValue(redisContext *_context, const char *_key, std::string &_outdata) {
	return ExecuteCmd(_context, _outdata, "GET %s ", _key);
}

bool HRedisBase::SetExKey(redisContext *_context, const char *_key, int _expire,const char* _value, std::string &_outdata) {
	return ExecuteCmd(_context, _outdata, "SETEX %s %d %s", _key, _expire,_value);
}
...
bool HRedisBase::GetList(redisContext *_context, const char *_key, int start,int stop,std::list<std::string> &_outlist) {
    return ExecuteCmd(_context, _outlist, "LRANGE  %s %d  %d", _key,start,stop);
}
...
bool HRedisBase::GetAllDataFromHash(redisContext *_context, const char *_hash_name, std::list<std::string> &_outlist) {
	return ExecuteCmd(_context, _outlist, "HGETALL %s ", _hash_name);
}
...
bool HRedisBase::GetKeysFromHashByScan(redisContext *_context, const char *_pattern, std::list<std::string> &_outlist) {
	return ExecuteCmd(_context, _outlist, "SSCAN %s", _pattern);
}
